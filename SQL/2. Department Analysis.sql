...
-- Department Analysis
-- GOAL: Discover which Department has the higest turnover risk.
-- ========================================================================================

-- STEP 1:
--Calculate the overall attrition rate of total number of employees?
SELECT
...
-- STEP 2:
--Caculate the total percentage of the company headcount?
SELECT
CASE 
...
-- STEP 3:
--Calculate the attrition rate of each department.
--See how each department contributes to the whole.
SELECT
	Department,
...
-- STEP 3:
--Calculate the attrition rate of each job role.
--See how each job role contributes to the whole.
SELECT
	jobRole,
...
-- STEP 5:
--Create an age range of the company's employees
--Calculate how each age range contributes to the attrition rate, turnover %, and company head count %
...
-- STEP 6:
--What's the salary range between all employees
--Calculate how each salary range contributes to the attrition rate, turnover %, and company head count %
WITH employee_range AS (
  SELECT
    Attrition,
    CASE
